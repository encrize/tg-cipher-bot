...
```bash
git clone https://github.com/encrize/tg-cipher-bot.git
cd tg-cipher-bot

export BOT_TOKEN=123456789:AAHexampleTokenFromBotFather
...
```python
FALLBACK_BOT_TOKEN = "123456789:AAHexampleTokenFromBotFather"
FALLBACK_ALLOWED_USER_ID = 123456789
```
